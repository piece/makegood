...
"/home/iteman/GITREPOS/stagehand-testrunner/tests/Stagehand/TestRunner/PHPUnitFailureTest.php:82\n",
    ...
    @Test
    public void setParentThatHasErrorButHasNoChild() throws FileNotFoundException {
        List<TestSuite> testResults = TestResultConverter.convert(new File(System.getProperty("user.dir") +
                                                                           String.valueOf(File.separatorChar) +
                                                                           "phpunit-results/error-no-child.log"
                                                                           ));
    ...
    @Test
    public void setParentThatHasFailureButHasNoChild() throws FileNotFoundException {
        List<TestSuite> testResults = TestResultConverter.convert(new File(System.getProperty("user.dir") +
                                                                           String.valueOf(File.separatorChar) +
                                                                           "phpunit-results/failure-no-child.log"
                                                                           ));
