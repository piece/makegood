 ...
 */
class PHPUnitContainer extends Container
{
    /**
     * Constructor.
     */
    ...
    protected function getCommandLineBuilderService()
    {
        ...
        return $this->services['command_line_builder'] = new $class($this->get('environment'), $this->get('legacy_proxy'), $this->get('os'), $this->get('plugin'), $this->get('phpunit.runner'), $this->get('terminal'), $this->get('test_target_repository'), $this->get('phpunit.command_line_option_builder'));
    }
    ...
    protected function getContinuousTestRunnerService()
    {
        ...
        $this->services['continuous_test_runner'] = $instance = new $class($this->get('phpunit.preparer'), $this->get('command_line_builder'));
        ...
        $instance->setRunner($this->get('phpunit.runner'));
    ...
    protected function getTestRunnerService()
    {
        ...
        $this->services['test_runner'] = $instance = new $class($this->get('phpunit.preparer'));

        $instance->setCollector($this->get('phpunit.collector'));
        $instance->setNotifier($this->get('notifier'));
        $instance->setRunner($this->get('phpunit.runner'));
     ...
     *
     * @return Object An instance of the phpunit.collector service
     */
    protected function getCollectorService()
    {
        return $this->get('phpunit.collector');
    }

    /**
     * Gets the command_line_option_builder service alias.
     *
     * @return Object An instance of the phpunit.command_line_option_builder service
     */
    protected function getCommandLineOptionBuilderService()
    {
        return $this->get('phpunit.command_line_option_builder');
    }

    /**
     * Gets the preparer service alias.
     *
     * @return Object An instance of the phpunit.preparer service
     */
    protected function getPreparerService()
    {
        return $this->get('phpunit.preparer');
    }

    /**
     * Gets the runner service alias.
     *
     * @return Object An instance of the phpunit.runner service
     */
    protected function getRunnerService()
    {
        return $this->get('phpunit.runner');
    }
