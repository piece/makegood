 ...
 */
class SimpleTestContainer extends Container
{
    /**
     * Constructor.
     */
    ...
    protected function getCommandLineBuilderService()
    {
        ...
        return $this->services['command_line_builder'] = new $class($this->get('environment'), $this->get('legacy_proxy'), $this->get('os'), $this->get('plugin'), $this->get('simpletest.runner'), $this->get('terminal'), $this->get('test_target_repository'), NULL);
    }
    ...
    protected function getContinuousTestRunnerService()
    {
        ...
        $this->services['continuous_test_runner'] = $instance = new $class($this->get('simpletest.preparer'), $this->get('command_line_builder'));
        ...
        $instance->setRunner($this->get('simpletest.runner'));
    ...
    protected function getTestRunnerService()
    {
        ...
        $this->services['test_runner'] = $instance = new $class($this->get('simpletest.preparer'));

        $instance->setCollector($this->get('simpletest.collector'));
        $instance->setNotifier($this->get('notifier'));
        $instance->setRunner($this->get('simpletest.runner'));
     ...
     *
     * @return Object An instance of the simpletest.collector service
     */
    protected function getCollectorService()
    {
        return $this->get('simpletest.collector');
    }

    /**
     * Gets the preparer service alias.
     *
     * @return Object An instance of the simpletest.preparer service
     */
    protected function getPreparerService()
    {
        return $this->get('simpletest.preparer');
    }

    /**
     * Gets the runner service alias.
     *
     * @return Object An instance of the simpletest.runner service
     */
    protected function getRunnerService()
    {
        return $this->get('simpletest.runner');
    }
